...
import com.dmtd.hanfu.forum.util.ResponseUtils;
...
public class FileUpLoadController {
	...
	public String upload(@RequestParam("file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
		...
		// 向前台返回文件地址
		ResponseUtils.write(response, request.getContextPath() + Config.DEFAULT_UPLOAD_ADDRESS + File.separator + fileName);
